    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div style="padding:0px 0px;">
                ...
                <h4 style="margin-top:1em;" > <strong> <?php echo $book['price']; ?></strong></h4>
            ...
            <div class="row" style="margin-top:3em; margin-bottom:1em;">
                <div class="col-sm-4">
                    ...
                    <span><input type="number" id="qtybtn" style="width:40%; display:inline-block;" id='quantity' name="quantity" min="1" maxlength="2" class="form-control" value="<?php echo $qty;?>"  required/></span>
                </div>
                <div class="col-sm-4">
                    <input type="hidden" class="form-control"  name="book_id" value="<?php echo $book['book_id'];?>">
                    <input type="hidden" class="form-control"  name="user_id" value="<?php echo $user['user_id'];?>">
                    <input type="hidden" class="form-control"  name="price" value="<?php echo $book['price'];?>">
                    <?php if ($userIn==true): ?>
                        <input  type="submit"  value="Add to Cart" style="width:100%;  text-transform:uppercase;" id="addToCartbtn" name="addToCart" class="btn btn-primary">
                    <?php endif; ?>
                </form>        
                    <?php if ($userIn==false): ?>
                ...
                <div class="col-sm-4">
                    <a href="checkOutPage.php"   style="width:100%; text-transform:uppercase; font-weight:bold; font-size:1.1em; " name="buyNow" class="btn btn-success">Buy Now</a>
                </div>
